...
@pytest.mark.parametrize("length,value,expected", [(1, "a", True), (2, "a", False), (0, "a", False)])
...
@pytest.mark.parametrize(
    "length,value,expected", [(1, "a", True), (2, "aa", True), (0, "a", True), (2, "a", False), (3, "aa", False)]
)
...
@pytest.mark.parametrize(
    "length,value,expected", [(1, "a", True), (2, "aa", True), (0, "a", False), (2, "a", True), (3, "aa", True)]
)
...
@pytest.mark.parametrize("value,expected", [("A", True), ("aa", True), ("\u0394", False)])
...
@pytest.mark.parametrize("value,expected", [("123", True), ("123a", False), ("12.3", False)])
def test_only_numbers(value: str, expected: bool):
    r = cell.OnlyNumbers()
    assert r._evaluator()(*r._prepare(value)) is expected


@pytest.mark.parametrize("value,expected", [("0123", False), ("1023", True), ("0", True), ("0.0", False)])
...
@pytest.mark.parametrize("value,expected", [("1", True), ("0", True), ("0.0", False), ("0.1", False), ("a", False)])
...
@pytest.mark.parametrize("comparison,value,expected", [(1, "x", False), (1, "xx", True), (2, "xx", False)])
def test_length_gt(comparison: int, value: str, expected: bool):
    r = cell.LengthGT(comparison)
    assert r._evaluator()(*r._prepare(value)) is expected


@pytest.mark.parametrize("comparison,value,expected", [(1, "x", True), (1, "xx", True), (3, "xx", False)])
def test_length_gte(comparison: int, value: str, expected: bool):
    r = cell.LengthGTE(comparison)
    assert r._evaluator()(*r._prepare(value)) is expected


@pytest.mark.parametrize("comparison,value,expected", [(1, "x", True), (2, "xx", True), (3, "xx", False)])
...
@pytest.mark.parametrize(
    "comparison,value,expected", [(1, "x", True), (2, "xx", True), (3, "xx", True), (0, "x", False)]
)
...
@pytest.mark.parametrize(
    "comparison,value,expected", [(1, "x", False), (2, "xx", False), (3, "xx", True), (0, "x", False)]
)
...
@pytest.mark.parametrize(
    "comparison,value,expected", [(1, "1", False), (1, "2", True), (1, "1.1", True), (0, "0", False)]
)
...
@pytest.mark.parametrize(
    ...
    [(1, "1", True), (1, "2", True), (1, "1.1", True), (1, "1.0", True), (0, "0", True), (1, "0", False)],
)
...
@pytest.mark.parametrize(
    "comparison,value,expected",
    [(1, "1", True), (1, "2", False), (1, "1.1", False), (1, "1.0", True), (0, "0", True), (1, "0", False)],
)
...
@pytest.mark.parametrize(
    "comparison,value,expected",
    [(1, "1", True), (1, "2", False), (1, "1.1", False), (1, "1.0", True), (0, "0", True), (1, "0", True)],
)
...
@pytest.mark.parametrize(
    "compared,data,expected",
    [("x", ("1", {"x": "0"}), True), ("x", ("1", {"x": "1"}), False), ("z", ("1", {"x": "1", "z": "0"}), True)],
)
...
@pytest.mark.parametrize(
    "compared,data,expected",
    [("x", ("0", {"x": "1"}), True), ("x", ("1", {"x": "1"}), False), ("z", ("0", {"x": "0", "z": "1"}), True)],
)
